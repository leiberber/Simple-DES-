public class Decipher {
    public static String Decipher(String input) {
        ...
        String R_S8 = F_round.XOR(R_E8, K_2); // 亦或K_2和R_E8
        ...
        // IP_1置换
        String Plaintext = IP.IP_1(IP_1_text);
